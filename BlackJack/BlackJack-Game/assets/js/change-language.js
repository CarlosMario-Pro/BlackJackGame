...
const restoreLanguage = () => {
    if (localStorage.getItem("language")) {
        if (localStorage.getItem("language") === "spanish") {
            ...
            titleBetHome.innerHTML = "Apuesta";
            ...
            modalBodyItems[0].innerHTML = "Juegos: ";
            modalBodyItems[1].innerHTML = "ganadas: ";
            modalBodyItems[2].innerHTML = "Perdidas: ";
            modalBodyItems[3].innerHTML = "empatadas: ";
            modalBodyItems[4].innerHTML = "Reiniciadas: ";
            ...
            modalHelpBody[0].innerHTML = "El objetivo del juego es conseguir una puntuación mayor que la del crupier, pero sin pasarse de 21.";
            modalHelpBody[1].innerHTML = "Las cartas de valor numérico valen su número. Las cartas de figura valen 10. El As vale 11.";
            modalHelpBody[2].innerHTML = "Cada jugador comienza con dos cartas, una de las cartas del crupier está oculta hasta el final.";
            modalHelpBody[3].innerHTML = "El boton 'Pedir' es pedir otra carta. El boton 'Plantarse' es quedarse con tu total de cartas y terminar tu turno.";
            modalHelpBody[4].innerHTML = "El boton 'Doblar' es doblar tu apuesta, y recibir una y solo una carta más.";
            modalHelpBody[5].innerHTML = "Si te pasas de 21 pierdes, y el crupier gana sin importar la mano del crupier.";
            ...
            modalHelpBody[0].innerHTML = "The goal of Blackjack is to beat the dealer's hand without going over 21.";
            modalHelpBody[1].innerHTML = "Face cards are worth 10. Aces are worth 1 or 11, whichever makes a better hand.";
            modalHelpBody[2].innerHTML = "Each player starts with two cards, one of the dealer's cards is hidden until the end.";
            modalHelpBody[3].innerHTML = "To 'Hit' is to ask for another card. To 'Stand' is to hold your total and end your turn.";
            modalHelpBody[4].innerHTML = "To 'Double Down' is to double your bet, and receive one and only one more card.";
            modalHelpBody[5].innerHTML = "If you go over 21 you bust, and the dealer wins regardless of the dealer's hand.";
